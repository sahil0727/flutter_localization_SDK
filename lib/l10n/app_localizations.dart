...
abstract class AppLocalizations {
  ...
  /// No description provided for @decks_porches.
  ///
  /// In en, this message translates to:
  /// **'Decks & Porcges'**
  String get decks_porches;

  /// No description provided for @electrical_computers.
  ///
  /// In en, this message translates to:
  /// **'Electrical & Computers'**
  String get electrical_computers;
  ...
  /// No description provided for @tile_stone.
  ///
  /// In en, this message translates to:
  /// **'Tile & Stone'**
  String get tile_stone;
